  ...
  <div>
    <nav class="topnav" style="top: 0px">
        ...
        <a href="/" class="item logo" style="opacity: 1">
          ...
          >
            <defs>
              ...
              >
                <stop offset="0.01" stop-color="#eb844e"></stop>
                <stop offset="1" stop-color="#ee4358"></stop>
              </linearGradient>
            </defs>
      ...
      <div class="topnav-links flex-center hide-sm">
        ...
        <a href="/posts/allposts" class="item item-text" aria-label="All Posts">
          Posts
        </a>
        <a
      ...
      <div class="topnav-icons flex-center">
        <a ng-version="12.2.4" style="visibility: visible">
          <span @click="toggle_theme" slot="dark" class="item"
